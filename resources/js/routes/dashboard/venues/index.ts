...
/**
* @see \App\Http\Controllers\Dashboard\VenueController::submit
 * @see app/Http/Controllers/Dashboard/VenueController.php:103
 * @route '/dashboard/venues/{venue}/submit'
 */
export const submit = (args: { venue: string | { slug: string } } | [venue: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/dashboard/venues/{venue}/submit'
 */
submit.url = (args: { venue: string | { slug: string } } | [venue: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { venue: args }
    }
 ...
 * @route '/dashboard/venues/{venue}/submit'
 */
submit.patch = (args: { venue: string | { slug: string } } | [venue: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: submit.url(args, options),
    method: 'patch',
})
 ...
 * @route '/dashboard/venues/{venue}/submit'
 */
    const submitForm = (args: { venue: string | { slug: string } } | [venue: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/dashboard/venues/{venue}/submit'
 */
        submitForm.patch = (args: { venue: string | { slug: string } } | [venue: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: submit.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
