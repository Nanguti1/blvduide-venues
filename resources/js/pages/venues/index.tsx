...
export default function VenueIndex() {
    const { venues, categories, features } = usePage().props as any;
                        ...
                        <div>
                            ...
                            <div className="mt-2 grid gap-2">
                                {features.slice(0, 6).map((feature: any) => (
                                    <span
                                        key={feature.id}
                                        className="inline-flex rounded-full bg-slate-100 px-3 py-1 text-sm text-slate-700 dark:bg-slate-800 dark:text-slate-300"
                                    >
                                        {feature.name}
                                    </span>
                                ))}
