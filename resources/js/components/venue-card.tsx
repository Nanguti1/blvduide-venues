    ...
    return (
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-slate-700 dark:bg-slate-900">
            <div className="mb-4 flex items-center justify-between gap-3">
                <div>
                    <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">{venue.title}</h2>
                    <p className="text-sm text-slate-500 dark:text-slate-400">{venue.category?.name}</p>
                </div>
            ...
            <p className="mb-4 text-sm leading-6 text-slate-600 dark:text-slate-300">{venue.short_description}</p>
            ...
            <div className="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-xl font-semibold text-slate-900 dark:text-slate-100">${venue.price ?? 'Contact'}</p>
                </div>
                <Link
